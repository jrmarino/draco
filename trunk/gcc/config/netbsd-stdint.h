...
#define UINT_LEAST64_TYPE (LONG_TYPE_SIZE == 64 ? "unsigned long int" : "unsigned long long int")
...
#define UINT_FAST64_TYPE  (LONG_TYPE_SIZE == 64 ? "unsigned long int" : "unsigned long long int")
